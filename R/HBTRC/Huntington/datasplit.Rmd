...
We, however, in this bit want more relevant information with respect to just Huntington's. So, I will load in some meta-data with restricted access. It is still not personally recognizable, but it cannot be made public. No attempt at personally identifying has been made.
```{r message=FALSE, warning=FALSE}
