...
RUN_TITLE = "ANOVA top 1000 features selected greedily with correlation below 0.8 \nThis run includes only 9 GCNs - mRNA, meth, mirna, meth_mrna, meth_mirna, mrna_mirna, mrna_mrna, meth_meth, mirna_mirna"
RUN_TITLE_SHORT = "brca_cross"
...
meth_mrna = "/data/users/bs16b001/R/TCGA BRCA/meth_mrna_anova.csv"
meth_mirna = "/data/users/bs16b001/R/TCGA BRCA/meth_mirna_anova.csv"
mrna_mirna = "/data/users/bs16b001/R/TCGA BRCA/mrna_mirna_anova.csv"
...
load_list = [mrna, meth, mirna, meth_mrna, meth_mirna, mrna_mirna, mrna_mrna, meth_meth, mirna_mirna, meta_csv, trte_partition_file]
GCN_names = ["mRNA","methylation","miRNA", "meth_mrna", "meth_mirna", "mrna_mirna", "mrna_mrna", "meth_meth", "mirna_mirna"]
