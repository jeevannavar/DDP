...
RUN_TITLE = "ANOVA top 1000 features selected greedily with correlation below 0.8 \nThis run includes only 6 GCNs - mrna, meth, mirna, mrna_mrna, meth_meth, mirna_mirna"
RUN_TITLE_SHORT = "brca_self"
...
load_list = [mrna, meth, mirna, mrna_mrna, meth_meth, mirna_mirna, meta_csv, trte_partition_file]
GCN_names = ["mRNA","meth","miRNA", "mrna_mrna", "meth_meth", "mirna_mirna"]
