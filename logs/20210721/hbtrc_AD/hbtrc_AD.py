...
# pre-processed data
cerebellum = "R/HBTRC/Alzheimer/cerebellum_AD.csv"
visualCortex = "R/HBTRC/Alzheimer/visualCortex_AD.csv"
prefrontalCortex = "R/HBTRC/Alzheimer/prefrontalCortex_AD.csv"
meta_csv = "R/HBTRC/Alzheimer/labels_AD.csv"
trte_partition_file = "R/HBTRC/Alzheimer/trte_partition_AD.txt"
...
feature_imp["shap"].to_csv("hbtrc_shap_AD.csv", index_label="features")
