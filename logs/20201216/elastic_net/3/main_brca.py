...
RUN_TITLE = "Features selected using elastic net"
RUN_TITLE_SHORT = "elastic_net"
print(RUN_TITLE)
...
if __name__ == "__main__":    
    # pre-processed data
    mrna_preproc_csv = "/data/users/bs16b001/R/TCGA BRCA/mrna_elasticnet.csv"
    meth_preproc_csv = "/data/users/bs16b001/R/TCGA BRCA/meth_elasticnet.csv"
