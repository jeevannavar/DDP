...
print("This run includes 6 GCNs - mRNA, DNA methylation, miRNA, and the naive mrna_meth, mrna_mirna, mirna_meth","\n")
...
if __name__ == "__main__":    
    ...
    test_inverval = 50
    lr = 1e-3
    GCN_names = ["mRNA","methylation","miRNA", "mrna_meth", "mrna_mirna", "mirna_meth"]
    ...
    plt.title("MORONET Losses - Naive Cross Interactions")
    plt.legend()
    #plt.show()
    time = str(datetime.datetime.now())
    plt.savefig("Losses_naivecross_"+time+".png")
    ...
    plt.title("MORONET Test Evaluation - BRCA Dataset - Naive Cross Interactions")
    plt.legend()
    #plt.show()
    plt.savefig("Test_Scores_naivecross_"+time+".png")
