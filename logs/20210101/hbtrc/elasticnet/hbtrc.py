...
# pre-processed data
cerebellum_csv = "/data/users/bs16b001/R/HBTRC/cerebellum_elasticnet.csv"
visualCortex_csv = "/data/users/bs16b001/R/HBTRC/visualCortex_elasticnet.csv"
prefrontalCortex_csv = "/data/users/bs16b001/R/HBTRC/prefrontalCortex_elasticnet.csv"
meta_csv = "/data/users/bs16b001/R/HBTRC/disease_class.csv"
trte_partition_file = "/data/users/bs16b001/R/HBTRC/trte_partition.txt"
...
REPEATS = 5 #Integer, how many times to independently train the model
