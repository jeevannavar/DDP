...
RUN_TITLE = "Complete data - miRNA"
RUN_TITLE_SHORT = "mirna"
print(RUN_TITLE)
print("This run includes only one GCN - miRNA","\n")
# assign GPU number
CUDA_DEVICE = 0
...
if __name__ == "__main__":    
    ...
    load_list = [mirna_preproc_csv] #, meth_preproc_csv, mirna_preproc_csv]
    ...
    test_inverval = 50
    lr = 1e-3
    GCN_names = ["miRNA"] #,"methylation","miRNA"]
