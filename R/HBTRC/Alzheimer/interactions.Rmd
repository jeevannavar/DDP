---
title: "Alzheimer's - Pairwise Interactions"
...
cere <- read_csv("cerebellum_AD.csv")
visual <- read_csv("visualCortex_AD.csv")
prefrontal <- read_csv("prefrontalCortex_AD.csv")
...
anova_sorted <- anova_summary %>% 
                     filter(p_value<=0.05/nrow(anova_summary)) %>% 
...
write_csv(data, "cere_visual_AD.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "visual_prefrontal_AD.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "prefrontal_cere_AD.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "cere_cere_AD.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "visual_visual_AD.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "prefrontal_prefrontal_AD.csv")
...
# Some preliminaries
# Selecting only training samples for doing the processing
cere <- read_csv("cerebellum_braak.csv")
visual <- read_csv("visualCortex_braak.csv")
prefrontal <- read_csv("prefrontalCortex_braak.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "cere_visual_braak.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "visual_prefrontal_braak.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "prefrontal_cere_braak.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "cere_cere_braak.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "visual_visual_braak.csv")
...
data <- rbind(data_train, data_test)
data <- data[match(labels$patient_id, data$patient_id), ]
write_csv(data, "prefrontal_prefrontal_braak.csv")
