...
matrix <- dplyr::rename(matrix, "gcn_shap"="shapley_values", "gcn_lime"="aggregate.x", "anova"="f_value", "svm_lime"="aggregate.y")
...
gcnlime_gs %>%
  ...
  geom_bar(stat = "identity")+
  theme_minimal()+
  labs(y = "Top Significant Genesets at FDR = 5%", x = "Normalized Enrichment Score", title = "Gene Set Enrichment Analysis Results", fill = "Sub-collection")
```
